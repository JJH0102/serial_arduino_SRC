...
conn = pymysql.connect(host='10.10.13.126', user='user1', password='1234', db='dht11', charset='utf8')
print("Serial port opened successfully")

conn = pymysql.connect(host='localhost', user='user1', password='1234', db='dht11', charset='utf8')
curs = conn.cursor()
